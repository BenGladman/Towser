...
{
    /// <summary>
    /// Manages comms between Telnet server and SignalR hub clients which understand ANSI escape sequences.
    /// (Note - ADAC = ANSI Decoding At Client.)
    /// </summary>
    public class AdacHub : Hub<ITerminal>
    {
